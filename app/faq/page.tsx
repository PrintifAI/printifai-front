            ...
            <div className={styles.wrapper}>
                ...
                <div className={styles.accordions}>
                    ...
                    <Accordion title="Способы доставки">
                        На данный момент доступны 2 способа доставки – Почта
                        России и СДЭК
                    </Accordion>
                    <Accordion title="Как отслеживать заказ?">
                        После оформления заказа с вами свяжется администратор,
                        который предоставит ссылку на отслеживание заказа
                    </Accordion>
